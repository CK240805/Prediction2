#!/usr/bin/env python3
"""
LottOracle‑Simple‑TightTolerance
================================
6/49 prediction with 1% mass tolerance.
Uses physics (air‑mix), EWMA state estimation, Dirichlet‑Multinomial likelihood,
cross‑validated α calibration, and Monte Carlo set sampling.

Ball specs: 3.3 g ± 0.033 g (1%), 40 mm diameter.
"""
...
MIN_HISTORY_FOR_CAL = 100          # minimum draws before likelihood evaluation
...
BALL_MASS_TOL  = 0.033e-3          # kg  (±1% of 3.3g)
EWMA_DECAY = 0.98                  # more weight on recent draws
TREND_WINDOW = 20
...
# =============================================================================
# 4. TREND FEATURE (optional, but kept for future)
# =============================================================================
...
# =============================================================================
# 7. CROSS‑VALIDATION CALIBRATION (only α, with env and trend frozen at 0)
# =============================================================================
def cv_log_likelihood(params, draws_cal, dates_cal, min_history=MIN_HISTORY_FOR_CAL):
    # params: alpha, log_concentration  (beta, gamma, delta fixed at 0)
    ...
    for i in range(n_draws):
        draw = draws_cal[i]
        # Do not evaluate likelihood for the first min_history draws
        if i >= min_history:
