#!/usr/bin/env python3
"""
LottOracle – 3.9g balls (1% tolerance)
======================================
6/49 prediction with updated ball mass: 3.9 g ± 0.039 g.
...
NUM_BALLS = 49
DRAW_SIZE = 6
BALL_MASS_MEAN = 3.9e-3            # kg  (new balls)
BALL_MASS_TOL  = 0.039e-3          # kg  (±1% of 3.9g)
EWMA_DECAY = 0.98
TREND_WINDOW = 20
...
# =============================================================================
# 4. TREND FEATURE (kept for future use)
# =============================================================================
...
# =============================================================================
# 7. CROSS‑VALIDATION CALIBRATION (α only)
# =============================================================================
